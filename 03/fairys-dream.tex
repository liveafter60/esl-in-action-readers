...
\fancyhead[RE]{\estcab{Fairy's Dream}}
...
\fancyhead[LO]{\estcab{Fairy's Dream}} % malo cuando no hay section ~~~ \thesection
...
\section*{Fairy's Dream.}

\Large
\lettrine[lines=3]{\initfamily\textcolor{darkgreen}{F}}{airy} fell asleep one
day\\
...
\begin{figure}[H]
\centering
\includegraphics[height=2.8in]{fig-03.png}
\end{figure}
